class Position:
    ...
    # It is a convention that default format where format_spec has no value should have same value as __str__
    def __str__(self):
        return format(self)
    ...
    def __format__(self, format_spec):
        ...
        return (
            f"{abs(self.latitude)}u'\u00b0' {self.latitude_hemisphere}"
            f"{abs(self.longitude)}u'\u00b0' {self.longitude_hemisphere}"
        )
